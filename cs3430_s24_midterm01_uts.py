...
class cs3430_s24_midterm01_uts(unittest.TestCase):
    ...
    def test_midterm01_land_allocation_ut(self):
        ...
        print('number of acres for crop A = {}'.format(-1))
        print('number of acres for crop B = {}'.format(-1))
        print('number of acres for crop C = {}'.format(-1))
        print('p:  maximum profit = {}'.format(-1))
